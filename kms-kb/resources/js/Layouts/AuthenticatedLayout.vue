...
<template>
    <div>
        <div class="min-h-screen 800 pt-6 pb-6 kms-bg">
            <nav
            ...
            >
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-center">
                        <div class="flex">
                            <!-- Logo -->
                            <div class="flex shrink-0 items-center" id="logo">
                                <a href="/">
                                    <ApplicationLogo
                                        class="block h-9 w-auto fill-current text-white-500"
                                    />
                                </a>
                            </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center rounded-md  border-transparent px-3 py-2 text-sm font-medium leading-4 text-gray-200 transition duration-150 ease-in-out hover:text-gray-500 focus:outline-none" style="background-color: transparent;"
                                            >
