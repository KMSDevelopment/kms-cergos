            ...
            <div class="kms-car-dashboard-inside">
                ...
                <div class="kms-dashboard-description">
                        ...
                        <table style="width:100%; text-align:center; font-size:18px; margin-top:10px;">
                            <tr>
                                <td style="text-align:center;">
                                    <a href="#" class="btnspecs btnfilter_specs" data-toggle="tooltip" data-placement="top" title="Filteren">
                    ...
                    <div class="dashboard-info-specs dshb-search" style="display:none; padding-top:10px;">
                        <input type="text" class="form form-control dshb-input-search" placeholder="Type ticket nummer of automerk">
                        <br/>
                        <em style="color:#FFF; font-size:12px;">Zoek op basis type, model of automerk.</em>
                    </div>
